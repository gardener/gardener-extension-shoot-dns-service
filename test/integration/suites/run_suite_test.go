...
import (
	...
	_ "github.com/gardener/gardener-extension-shoot-dns-service/test/integration/healthcheck"
...
func TestGardenerSuite(t *testing.T) {
	RunSpecsWithDefaultAndCustomReporters(t, "Shoot-dns-service Test Suite", []Reporter{reporter.NewGardenerESReporter(*reportFilePath, *esIndex)})
}
