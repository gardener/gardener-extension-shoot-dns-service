...
**Disclaimer:** This document is NOT a step by step deployment guide for the shoot DNS service extension and only contains some configuration specifics regarding the deployment of different components via the helm charts residing in the shoot DNS service extension [repository](https://github.com/gardener/gardener-extension-shoot-dns-service).
